...
export default function BiografiaSection() {
  return (
    <section id="biografia" className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-red-50 to-gray-50 rounded-2xl p-8 mb-12 shadow-lg border border-red-100">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-lg text-gray-700 mt-4 leading-relaxed">
              Actualmente es el <strong className="text-red-600">Secretario General del partido Todo con el Pueblo (TCP)</strong>, liderando el proceso de consolidación del partido y la recolección de firmas para su inscripción oficial.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-gray-900">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-gray-900 rounded-full flex items-center justify-center">
                <Building className="h-6 w-6 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900">Sector Público</h3>
            </div>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-2">
          ...
          {/* Liderazgo Político */}
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-red-600 md:col-span-2">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center">
                <Briefcase className="h-6 w-6 text-white" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-900">Secretario General - Todo con el Pueblo (TCP)</h3>
                <p className="text-gray-500">Febrero 2024 - Actualidad</p>
              </div>
            </div>
